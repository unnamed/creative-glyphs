...
public interface Writeable {
    ...
    /**
     * Creates a {@link Writeable} representing the given
     * {@code bytes}, they are directly written into the
     * {@link OutputStream} using {@link OutputStream#write}
     */
    static Writeable ofBytes(byte[] bytes) {
